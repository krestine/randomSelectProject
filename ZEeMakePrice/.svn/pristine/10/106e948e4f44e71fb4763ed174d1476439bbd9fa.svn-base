...
@import
	url(http://fonts.googleapis.com/css?family=Ubuntu:300,400,500,700);

@import
	url(http://fonts.googleapis.com/css?family=Open+Sans:400,600,300);
...
#cssmenu>ul>li>a {
	...
	display: block;
	background:
		url(http://cssmenumaker.com/sites/default/files/menu/273//pattern.png)
		top left repeat;
	color: #ffffff;
...
#cssmenu>ul>li.has-sub>a span {
	background:
		url(http://cssmenumaker.com/sites/default/files/menu/273//icon_plus.png)
		96% center no-repeat;
}

#cssmenu>ul>li.has-sub.active>a span {
	background:
		url(http://cssmenumaker.com/sites/default/files/menu/273//icon_minus.png)
		96% center no-repeat;
}
/* Sub menu */
#cssmenu ul ul {
