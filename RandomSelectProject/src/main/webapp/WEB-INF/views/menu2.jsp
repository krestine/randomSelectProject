	...
	<center>
		<div class="btn-group">
			<c:choose>
				<c:when test="${sessionScope.loginUser==null}">
					<form id="select1" method="post" style="display: inline;">
						<input type="button" style="width: 150px; height: 100px;"
							class="btn btn-default " onclick="loginGo()" value="로그인">
						<input type="button" style="width: 150px; height: 100px;"
							class="btn btn-warning" onclick="registerGo()" value="회원가입">
					</form>
				</c:when>
				...
				<c:when test="${sessionScope.loginUser.memGrade<7}">
					<form id="select1" method="post" style="display: inline;">
						...
						<input type="button" style="width: 150px; height: 100px;"
							class="btn btn-info" onclick="myInfoGo()" value="내정보">
					</form>
				</c:when>
			...
			<form id="select3" style="display: inline;">
				<input type="button" style="width: 150px; height: 100px;"
					class="btn btn-primary" onclick="selectResult()" value="아무거나">
			...
			<form id="select2" method="post" style="display: inline;">
				<input type="button" style="width: 150px; height: 100px;"
					class="btn btn-default" onclick="settingGo()" value="설   정">
				<input type="button" style="width: 150px; height: 100px;"
					class="btn btn-default" onclick="mateListGo()" value="커뮤니티">
				
				<!-- 	<div class="btn-group">
					<input type="button" style="width: 150px; height: 100px;"
						class="btn btn-success" data-toggle="dropdown" value="커뮤니티">
					onclick="mateListGo()"
					<ul class="dropdown-menu" role="menu">
						<li><a href="mateListProc.do">친구리스트
								페이지 </a></li>
						<li><a
							href="restntListProc.do">식당리스트
								페이지 </a></li>
				...
				<div class="btn-group">
					<input type="button" style="width: 150px; height: 100px;"
						class="btn btn-info" data-toggle="dropdown" value="평  가">
