	...
	<center>
		<div class="btn-group">
				...
				<c:when test="${sessionScope.loginUser.memGrade<7}">
					<form id="select1" method="post" style="display: inline;">
						...
						<ul class="dropdown-menu" role="menu">
							<li><input class="btn btn-success btn-sm"
								onclick="mateListGo()" value="친구리스트"></li>
							<li><input class="btn btn-success btn-sm"
								onclick="restntListGo()" value="식당리스트"></li>
						</ul>
					</form>
				</c:when>
			...
			<form id="select2" method="post" style="display: inline;">
				...
				<div class=btn-group>
					<input type="button" style="width: 150px; height: 100px;"
						class="btn btn-success dropdown-toggle" value="커뮤니티"
