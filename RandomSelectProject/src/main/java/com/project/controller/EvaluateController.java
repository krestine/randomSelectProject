...
public class EvaluateController {
	...
	public String getEvaluateListForm(HttpServletRequest request, Model model,
			String memId) {
		System.out.println("getEvaluateListForm");
		return "forward:evaluateListForm";
	}*/
	...
	public ModelAndView evaluateListForm(HttpServletRequest request,
		...
		// 글 수
		view.addObject("evaluateList", evaluateList);
		// 게시글 리스트
